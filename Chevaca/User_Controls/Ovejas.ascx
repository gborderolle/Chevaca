<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ovejas.ascx.cs" Inherits="Chevaca.User_Controls.Ovejas" %>
<h2>Lista de ovejas</h2>

<asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
<asp:GridView ID="gridOvejas" runat="server" ClientIDMode="Static" HorizontalAlign="Center" AutoGenerateColumns="False" ShowFooter="True"
    CssClass="table table-hover table-striped"
    DataKeyNames="Oveja_ID"
    OnRowCommand="gridOvejas_RowCommand"
    OnRowCancelingEdit="gridOvejas_RowCancelingEdit"
    OnRowEditing="gridOvejas_RowEditing"
    OnRowUpdating="gridOvejas_RowUpdating"
    OnRowDataBound="gridOvejas_RowDataBound"
    OnRowDeleting="gridOvejas_RowDeleting">

    <EmptyDataRowStyle ForeColor="Red" CssClass="table table-bordered" />
    <EmptyDataTemplate>
        ¡No hay ovejas con los parámetros seleccionados!  
    </EmptyDataTemplate>
    ...
    <Columns>
        <asp:BoundField DataField="Oveja_ID" HeaderText="ID" HtmlEncode="false" ReadOnly="true" Visible="false" />
...
<asp:HiddenField ClientIDMode="Static" ID="hdnOvejasCount" runat="server" />
